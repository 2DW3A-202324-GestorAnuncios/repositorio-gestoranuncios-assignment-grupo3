        ...
        <div id="footer-content" class="ct-new-columns">
          ...
          <div id="footer-right" class="ct-div-block">
            <div id="seccion-logos-arriba" class="ct-div-block">
              <img src="img/FP-Euskadi.png" alt="FP Euskadi" class="ct-image" sizes="(max-width: 292px) 100vw, 292px">
              <img src="img/Hezkuntza.png" alt="Logo" class="ct-image">
              <img src="img/Lanbide-217x300.png" alt="Logo" class="ct-image">
            </div>
            <div id="seccion-logos-abajo" class="ct-div-block">
              <img src="img/ivaf-eiei-min.png" alt="Logo" class="ct-image">
              <img src="img/Ikaslan-Bizkaia-768x404.png" alt="Logo" class="ct-image">
            </div>
          </div>
        </div>
      </div>
