...
(6, 'Iphone 13', 529, 'Lo vendo porque me voy a comprar el nuevo IPhone 15\r\nSalud batería: 87%\r\nGarantía vigente\r\n120gb\r\nFactura\r\nSe puede ver sin compromiso\r\nEstá totalmente nuevo\r\nPoco uso ya que utilizo el móvil de empresa con normalidad\r\nPRECIO POCO NEGOCIABLE\r\nAbstenerse ofertas ridículas', 'iphone13.webp', 'Admin_ekaitz', '1'),
(7, 'apuntes', 20, 'son los apuntes del año pasado en limpio y con un examen de regalo', 'apuntes.jpg', 'Admin_luka', '1'),
(8, 'Sillas escritorio IKEA', 25, 'Sillas escritorio modelo Logerbet / Malskar de IkEA. Silla blanca y cojín negro. Precio silla con cojín 25€. Venta 4 sillas conjuntamente 80€. NO negociable.', 'silla_ikea.webp', 'Admin_aketza', '1'),
(9, 'CAMISETA HOMBRE PRIMERA EQUIPACIÓN', 85, 'Esta camiseta de manga corta te hará sentir como un gran profesional. Celebra la historia del Athletic Club mientras apoyas a tu equipo favorito.', 'primeraEquip.webp', 'Admin_ekaitz', '1'),
(10, 'CAMISETA HOMBRE SEGUNDA EQUIPACIÓN', 85, 'Muévete como un león con esta camiseta de la segunda equipación para hombre. Confeccionada con un tejido ligero y transpirable y con un práctico cuello de pico, esta camiseta aporta comodidad para que te mantengas fresco en las gradas de San Mamés.', 'segundaEquip.webp', 'Admin_ekaitz', '1'),
(11, 'Iphone 13', 529, 'Lo vendo porque me voy a comprar el nuevo IPhone 15\r\nSalud batería: 87%\r\nGarantía vigente\r\n120gb\r\nFactura\r\nSe puede ver sin compromiso\r\nEstá totalmente nuevo\r\nPoco uso ya que utilizo el móvil de empresa con normalidad\r\nPRECIO POCO NEGOCIABLE\r\nAbstenerse ofertas ridículas', 'iphone13.webp', 'Admin_ekaitz', '1'),
(12, 'apuntes', 20, 'son los apuntes del año pasado en limpio y con un examen de regalo', 'apuntes.jpg', 'Admin_luka', '1'),
(13, 'Sillas escritorio IKEA', 25, 'Sillas escritorio modelo Logerbet / Malskar de IkEA. Silla blanca y cojín negro. Precio silla con cojín 25€. Venta 4 sillas conjuntamente 80€. NO negociable.', 'silla_ikea.webp', 'Admin_aketza', '1'),
(14, 'CAMISETA HOMBRE PRIMERA EQUIPACIÓN', 85, 'Esta camiseta de manga corta te hará sentir como un gran profesional. Celebra la historia del Athletic Club mientras apoyas a tu equipo favorito.', 'primeraEquip.webp', 'Admin_ekaitz', '1'),
(15, 'CAMISETA HOMBRE SEGUNDA EQUIPACIÓN', 85, 'Muévete como un león con esta camiseta de la segunda equipación para hombre. Confeccionada con un tejido ligero y transpirable y con un práctico cuello de pico, esta camiseta aporta comodidad para que te mantengas fresco en las gradas de San Mamés.', 'segundaEquip.webp', 'Admin_ekaitz', '1');
...
(9, 'noticia-barca.webp', 'El Barça logró imponerse a todos sus fantasmas en Oporto', 'Ganó por fin fuera de casa un partido importante en Champions y con muchas bajas', 'deportes', 'Admin_ekaitz', '1'),
(10, 'noticia-ansu.webp', 'El plan del Brighton para poner a tope a Ansu Fati: \"No queremos presionarle\"', 'El español marcó su primer gol en la Premier y continúa creciendo poco a poco en el Brighton', 'deportes', 'Admin_ekaitz', '1'),
(11, 'noticia-mvps-euroliga.webp', 'Las estrellas que aspiran a coronarse MVP de la Euroliga', 'Nikola Mirotic, Wade Baldwin, Mike James, Edy Tavares, Kevin Punter, Will Clyburn, Nikola Milutinov, Facundo Campazzo... son algunos de los jugadores que optan a ser el el mejor de la temporada', 'deportes', 'Admin_ekaitz', '0'),
(12, 'noticia-calima-canarias-septiembre-2023.webp', 'Última hora calor y calima en Canarias: se suspenden las clases', 'Canarias suspende las clases este miércoles y el viernes debido a la situación meteorológica', 'tiempo', 'Admin_ekaitz', '1'),
(13, 'noticias-circo.avif', 'El Premio Nacional de Circo 2023 reconoce el gran formato en carpa de Productores de Sonrisas', 'El jurado ha destacado la trayectoria profesional de los hermanos González Villanueva y la fusión entre la tradición y la innovación', 'arte', 'Admin_dwayne', '1'),
(14, 'noticia-precipitaciones.webp', 'Previsión de lluvias en el Puente del Pilar 2023: ¿cuándo va a llover?', 'La lluvia y el cambio de tiempo llegará el fin de semana: llegan borrascas y ambiente más fresco', 'tiempo', 'Admin_luka', '1'),
(15, 'noticia-borrascas.webp', '¿Qué tiempo hará la próxima semana? Baile de borrascas y ambiente fresco', '¿Qué tiempo hará la próxima semana? Por fin tendremos tiempo otoñal, con la llegada de varias borrascas y temperaturas más frescas', 'tiempo', 'Admin_aketza', '1'),
(16, 'noticia-mitologia-japonesa.webp', 'Cómo la mitología japonesa explica los videojuegos y mangas: la huella ancestral en Pokémon y Hello Kitty', 'El nuevo museo Young V&A muestra en Londres la inspiración que mangas, animes y videojuegos han tomado de las tradiciones de la cultura nipona', 'arte', 'Admin_ekaitz', '1');
...
('Admin_ekaitz', 'Ekaitz', 'Angulo', '2004-01-12', 'Masculino', 'ekaitzanguloo@gmail.com', '$2y$10$IxmyDv.2.boBD9iQpzKhJeSWPyOiudz.RudPwbLoSKRyviDcU06Om', 'admin', ''),
